...
class anasayfa {
    ...
    function listeanasayfa($anasayfadb) {
        ...
        <div class="col-lg-12 col-md-12 col-xl-12 mx-auto bg-light" style="text-align: center;" >
        ...
        <form action="POST">
            <div class="col-lg-12 col-md-12 col-xl-12 mx-auto bg-light border border-secondary">
                    ...
                    ?>
                        ...
                        <div class="col-lg-1 col-md-1 col-xl-1 text-center text-dark  font-weight-bold border-right border-bottom p-1" ><?php echo $listeson["stok"]; ?> </div>
                        ...
                        HOCAM BURADA ÖNE ÇIKANLARI EKLEDİM AMA TASARIMSAL OLARAK ÇOK KÖTÜ OLDU BENDE BÖYLE BIRAKTIM

                        <div class="row">
                            <div class="container">
                                <div class="col-lg-4 col-md-4 col-xl-4">
                                    Öne Çıkar : <input type="radio" <?php //if($listeson["onecikar"]==1): ?> checked <?php //else: endif; ?>
                                </div>
                            </div>
                        </div>
    ...
    function urunguncelle($urunguncelledb){
        ...
        ?>
                      ...
                      <div class="form-check">
                        ...
                        <?php if ($urungosterson["onecikar"]==1): ?> checked <?php else: endif; ?> value="" id="defaultCheck1">
...
//burada rand vardı sildim
            ...
            if(empty($mail) || empty($sifre) || empty($yetki)):
              ...
              $giris=$yonetimgirisdb->prepare("SELECT * FROM kullanici WHERE mail=:mail && sifre=:sifre && yetki=:yetki");
              $giris->bindParam(":mail",$mail);
              $giris->bindParam(":sifre",md5(sha1(md5($sifre))));
              ...
              if($sifregetirson["sifre"]==md5(sha1(md5($_POST["sifre"]))) && $sifregetirson["mail"]==$mail && $sifregetirson["yetki"]==$yetki):
                ...
                $_SESSION["yetki"]=$yetki;
                    ...
                    if($girisson["yetki"]==1):
                        ...
                        echo '<div class="col-xl-12 col-lg-12 col-md-12 mx-auto"><div class="alert alert-success">Kullanıcı Hoş Geldiniz</div></div>';
                        header("refresh:2,url=control.php?islem=anasayfa");
            ...
            ?>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 mx-auto">
                            <form class="user" action="" method="POST">
                                <div class="form-group">
                                    <input type="email"  class="form-control form-control-user" name="mail" placeholder="Mail Adresiniz...">
                                </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <input type="submit" class="btn btn-primary btn-user btn-block" value="GİRİŞ">
                                <a href="sifreyenile.php?yeni=sifreyenile">Şifre Yenileme</a>
                             </form>
                        </div>
    ...
    function sifreyenile($sifreyeniledb){
         ...
         if (isset($_POST["mailgonder"])):
            ...
            $idgetir = $sifreyeniledb->prepare("select id from kullanici where mail=:mail");
            ...
            $mail->Body = "http://localhost/siparis/yonetim/sifreyenile.php?yeni=yenisifreyonetim&id=".$idgetirson["id"]; // mail içeriği
            $mail->send();
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 mx-auto">
        ...
        function yenisifreyonetim($yenisifredb){

        if (isset($_POST["yenisifre"])):

            $kayit = $_POST["kayit"];

            $sifreyenile = $yenisifredb->prepare("update kullanici set sifre=:sifre,sifre2=:sifre2 where id=:id");
